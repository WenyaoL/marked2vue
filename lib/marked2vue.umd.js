(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.marked2vue = {}, global.vue));
    ...
    ***************************************************************************** */
    ...
    var _hoisted_1$d = ["src", "alt", "title"];
    ...
    var _hoisted_1$c = { class: "marked-vue-codeInline" };
    ...
    var _hoisted_1$b = { class: "marked-vue-em" };
    var script$b = /*#__PURE__*/ vue.defineComponent({
        __name: 'EmFont',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("em", _hoisted_1$b, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
    ...
    var _hoisted_1$a = { class: "marked-vue-deleteLine" };
    var script$a = /*#__PURE__*/ vue.defineComponent({
        __name: 'DeleteFont',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("del", _hoisted_1$a, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
    ...
    var _hoisted_1$8 = { class: "marked-vue-paragraph" };
    var script$8 = /*#__PURE__*/ vue.defineComponent({
        __name: 'Paragraph',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("p", _hoisted_1$8, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
        ...
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (__props.level == '1')
                    ...
                    : (__props.level == '2')
                        ? (vue.openBlock(), vue.createElementBlock("h2", {
                            key: 1,
                        ...
                        : (__props.level == '3')
                            ...
                            : (__props.level == '4')
                                ...
                                : (__props.level == '5')
                                    ? (vue.openBlock(), vue.createElementBlock("h5", {
                                        key: 4,
                                    ...
                                    : (vue.openBlock(), vue.createElementBlock("h6", {
                                        key: 5,
    ...
    var _hoisted_1$6 = { class: "marked-vue-blockquote" };
    var script$6 = /*#__PURE__*/ vue.defineComponent({
        __name: 'Blockquote',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("blockquote", _hoisted_1$6, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
    ...
    var _hoisted_1$5 = { class: "marked-vue-fence" };
    var script$5 = /*#__PURE__*/ vue.defineComponent({
        __name: 'CodeBlock',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("pre", _hoisted_1$5, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
    ...
    var _hoisted_1$4 = ["align"];
    var _hoisted_2$2 = ["align"];
    ...
    var _hoisted_1$3 = { class: "marked-vue-tr" };
    var script$3 = /*#__PURE__*/ vue.defineComponent({
        __name: 'Tablerow',
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (vue.openBlock(), vue.createElementBlock("tr", _hoisted_1$3, [
                    vue.renderSlot(_ctx.$slots, "default")
                ]));
            };
        }
    ...
    var _hoisted_1$2 = { class: "marked-vue-table" };
    var _hoisted_2$1 = { class: "marked-vue-thead" };
    var _hoisted_3 = {
        key: 0,
    ...
    var _hoisted_1$1 = { class: "marked-vue-li" };
        ...
        setup: function (__props) {
            return function (_ctx, _cache) {
                return (__props.ordered)
                    ? (vue.openBlock(), vue.createElementBlock("ol", {
                        key: 0,
    ...
    var VueRenderer = /** @class */function () {
      ...
      VueRenderer.prototype.blockquote = function (quote) {
        return vue.h(script$6, null, function () {
          return quote;
        });
      };
      ...
      VueRenderer.prototype.listitem = function (content) {
        return vue.h(script$1, null, function () {
          return content;
        });
      };
      VueRenderer.prototype.checkbox = function (checked) {
        if (checked) return vue.h('input', {
          checked: "",
          disabled: "",
          type: "checkbox"
        });
      ...
      VueRenderer.prototype.tablerow = function (content) {
        return vue.h(script$3, null, function () {
          return content;
        });
      };
      ...
      VueRenderer.prototype.strong = function (content) {
        return vue.h(script$9, null, function () {
          return content;
        });
      };
      /**
      ...
      VueRenderer.prototype.em = function (content) {
        return vue.h(script$b, null, function () {
          return content;
        });
      };
      /**
      ...
      VueRenderer.prototype.del = function (content) {
        return vue.h(script$a, null, function () {
          return content;
        });
      };
      /**
      ...
      VueParser.prototype.parse = function (tokens, top) {
        ...
        for (i = 0; i < l; i++) {
          ...
          switch (token.type) {
            ...
            case 'table':
              {
                ...
                l2 = token.header.length;
                for (j = 0; j < l2; j++) {
                  cell.push(this.renderer.tablecell(this.parseInline(token.header[j].tokens), {
                    header: true,
                    align: token.align[j]
                  }));
                }
                ...
                for (j = 0; j < l2; j++) {
                  ...
                  l3 = row.length;
                  for (k = 0; k < l3; k++) {
                    cell.push(this.renderer.tablecell(this.parseInline(row[k].tokens), {
                      header: false,
                      align: token.align[k]
                    }));
                  }
            ...
            case 'list':
              {
                ...
                for (j = 0; j < l2; j++) {
                  ...
                  itemBody.push.apply(itemBody, __spreadArray([], __read(this.parse(item.tokens, loose)), false));
            ...
            case 'text':
              {
                var body = [token.tokens && token.tokens.length > 0 ? this.parseInline(token.tokens) : token.text];
                while (i + 1 < l && tokens[i + 1].type === 'text') {
                  token = tokens[++i];
        ...
        var done_1 = function done_1(err) {
          ...
          if (!err) {
            try {
              ...
              if (opt.isVNodeModel) {
                out = VueParser.parse(tokens_1, opt);
              } else {
        ...
        if (opt.walkTokens) {
          if (opt.async) {
            return Promise.all(marked.walkTokens(tokens_2, opt.walkTokens)).then(function () {
              if (opt.isVNodeModel) {
                return VueParser.parse(tokens_2, opt);
              }
              return Parser.parse(tokens_2, opt);
            })["catch"](function (e) {
              return onError(e, opt.silent);
            });
          }
    ...
    marked.parseVNode = function (src, opt, callback) {
      return marked(src, Object.assign({
        isVNodeModel: true
      }, opt), callback);
    };
    marked.parseInlineVNode = function (src, opt) {
      return marked.parseInline(src, Object.assign({
        isVNodeModel: true
      }, opt));
    };
    /**
    ...
    var vueParser = VueParser.parse;
    var options = marked.options;
    var setOptions = marked.setOptions;
    var use = marked.use;
    var walkTokens = marked.walkTokens;
    var parseInline = marked.parseInline;
    var parseInlineVNode = marked.parseInlineVNode;
    var parse = marked;
    var parseVNode = marked.parseVNode;
    ...
    exports.parseInlineVNode = parseInlineVNode;
